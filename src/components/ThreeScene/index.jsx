...
const Model = () => {
  ...
  const allScene = useGLTF('/assets/models/Scene.glb');
  ...
  const handleScroll = () => {
    setRotation([initRotation[0] - 0.01 * window.scrollY, initRotation[1] - 0.01 * window.scrollY, initRotation[2]]);
  };
  ...
  return (
    <Suspense fallback={null}>
      ...
      <primitive object={allScene.scene}
...
const ThreeScene = () => {
  return (
    <Canvas className="!fixed w-full !h-[100vh] z-[-1]">
      <Model />
    </Canvas>
  );
};
